"""Gadgetbot Challenge completion tracking -- see
constants/gadgetbot_challenges.py's GADGETBOT_CHALLENGES for the per-challenge
case/address data (CONFIRMED live for every entry so far)."""
