"""High Stakes Room's per-location rules -- every location belonging to
...
case at all is already gated by its "To High Stakes Room" entrance (see
...
def set_high_stakes_room_rules(world: "SecretAgentClankWorld") -> None:
    ...
    if world.options.all_cutscenes:
        world.set_rule(mw.get_location(SACCutsceneLocations.HIGH_STAKES_ROOM_COMPLETE_CUTSCENE, player), True_())
