...
class SACRatchetChallengeLocations:
    ...
    PRISON_BREAKOUT_CATCH_AS_CATCH_CAN = "Prison Breakout! (Ratchet) - Catch-as-Catch-Can: Challenge Completed"
    PRISON_BREAKOUT_AMOEBOID_ON_A_POLE = "Prison Breakout! (Ratchet) - Amoeboid on a Pole: Challenge Completed"
    PRISON_BREAKOUT_IRON_MAN = "Prison Breakout! (Ratchet) - Iron Man: Challenge Completed"
    PRISON_BREAKOUT_TRIPLE_THREAT = "Prison Breakout! (Ratchet) - Triple Threat: Challenge Completed"
    PRISON_BREAKOUT_MEGA_CHALLENGE_BATTLE_ROYAL = "Prison Breakout! (Ratchet) - Mega Challenge: Battle Royal: Challenge Completed"
    THE_EXERCISE_YARD_LAST_ONE_PICKED_FOR_DODGEBALL = "Exercise Yard (Ratchet) - Last One Picked For Dodgeball: Challenge Completed"
    THE_EXERCISE_YARD_STEEL_IS_STEEL = "Exercise Yard (Ratchet) - Steel Is Steel: Challenge Completed"
    THE_EXERCISE_YARD_PUMPING_IRON_MOLTEN_IRON = "Exercise Yard (Ratchet) - Pumping Iron. Molten Iron.: Challenge Completed"
    THE_EXERCISE_YARD_GREAT_BALLS_OF_FIRE = "Exercise Yard (Ratchet) - Great Balls Of Fire!: Challenge Completed"
    THE_EXERCISE_YARD_MEGA_CHALLENGE_PRISON_YARD = "Exercise Yard (Ratchet) - Mega Challenge: Prison Yard: Challenge Completed"
    THE_MESS_HALL_NAILS_FOR_BREAKFAST = "Mess Hall (Ratchet) - Nails for Breakfast: Challenge Completed"
    THE_MESS_HALL_TYHRRANOID_RECYCLING = "Mess Hall (Ratchet) - Tyhrranoid Recycling: Challenge Completed"
    THE_MESS_HALL_ITS_RAINING_PHLEGM_HALLELUJAH = "Mess Hall (Ratchet) - It's Raining Phlegm! Hallelujah!: Challenge Completed"
    THE_MESS_HALL_MEATLOAF_TUESDAYS = "Mess Hall (Ratchet) - Meatloaf Tuesdays: Challenge Completed"
    THE_MESS_HALL_MEGA_CHALLENGE_CAFETERIA = "Mess Hall (Ratchet) - Mega Challenge: Cafeteria: Challenge Completed"
    THE_SHOWERS_NO_GOOD_DEED_GOES_UNPUNISHED = "The Showers (Ratchet) - No good deed goes unpunished.: Challenge Completed"
    THE_SHOWERS_COVER_YOUR_SHAME = "The Showers (Ratchet) - Cover Your Shame!: Challenge Completed"
    THE_SHOWERS_DIDNT_NEED_TO_SEE_THAT = "The Showers (Ratchet) - Didn't need to see that!: Challenge Completed"
    THE_SHOWERS_ITS_A_DRY_HEAT = "The Showers (Ratchet) - It's a Dry Heat: Challenge Completed"
    THE_SHOWERS_MEGA_CHALLENGE_SHOWER = "The Showers (Ratchet) - Mega Challenge: Shower: Challenge Completed"
    MAX_SECURITY_CELLS_KARMIC_BREAKDOWN = "Max-Security Cells (Ratchet) - Karmic Beatdown: Challenge Completed"
    MAX_SECURITY_CELLS_NO_SHELTER = "Max-Security Cells (Ratchet) - No Shelter: Challenge Completed"
    MAX_SECURITY_CELLS_PAST_DUE = "Max-Security Cells (Ratchet) - Past Due: Challenge Completed"
    MAX_SECURITY_CELLS_SPEAK_SOFTLY_AND = "Max-Security Cells (Ratchet) - Speak Softly And...: Challenge Completed"
    MAX_SECURITY_CELLS_MEGA_CHALLENGE_CELLBLOCK = "Max-Security Cells (Ratchet) - Mega Challenge: Cellblock: Challenge Completed"
