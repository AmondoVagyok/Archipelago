...
class SACMissionLocations:
    ...
    BOLTAIRE_MUSEUM_ESCAPE_THE_RAVINE = "Escape the Ravine"
    BOLTAIRE_MUSEUM_GET_INSIDE_THE_MUSEUM = "Get Inside the Museum"
    BOLTAIRE_MUSEUM_NOT_THE_GUIDED_TOUR = "Not The Guided Tour"
    BOLTAIRE_GEM_WING_THE_NIGHT_FOX = "The Night Fox"
    MAX_SECURITY_CELLS_LIFE_IN_PRISON = "Life In Prison"
    MAX_SECURITY_CELLS_CONSECUTIVE_LIFE_SENTENCES = "Consecutive Life Sentences"
    ROOFTOP_DEATHTRAP_GET_A_CLUE = "Get A Clue"
    ROOFTOP_DEATHTRAP_FREE_AGENT_CLANK = "Free Agent Clank!"
    ROOFTOP_DEATHTRAP_THE_HALLS_OF_ASYANICA = "The Halls of Asyanica"
    LARGER_THAN_LIFE_QWARKOGRAPHY_CH_1 = "Qwarkography, Ch. 1"
    COUNTESS_VILLA_TANGO_OF_100_SORROWS = "Tango of 100 Sorrows"
    ASYANICA_ROOFTOPS_NUMBER_WOO_WORKS_FOR = "Number Woo works for...?"
    GLACIARA_SKI_SLOPES_BLACK_DIAMOND_OF_DOOM = "Black Diamond of Doom!"
    GLACIARA_SKI_SLOPES_PRO_BOARDING = "Pro Boarding"
    THE_MESS_HALL_NO_TIME_FOR_SECONDS = "No Time for Seconds"
    THE_MESS_HALL_THE_LUNCH_MENU_FOREVER = "The Lunch Menu Forever"
    AZCOTAL_ALLEY_THE_KINGPIN = "The Kingpin"
    AZCOTAL_ALLEY_ALL_THE_KINGPIN_S_MEN = "All The Kingpin's Men"
    GONDOLA_ASCENT_GET_A_LIFT = "Get A Lift"
    SUCK_AND_JIVE_QWARKOGRAPHY_THE_GAMBLIN_YEARS = "Qwarkography, The Gamblin' Years"
    HIGH_ROLLERS_CASINO_EXPLORE_PARADISE = "Explore Paradise"
    HIGH_ROLLERS_CASINO_PARADISE_EXPLOITED = "Paradise Exploited"
    THE_EXERCISE_YARD_AND_THE_PASSWORD_IS = "And the password is..."
    THE_EXERCISE_YARD_FIGHT_FOR_SLIM = "Fight for Slim"
    HIGH_STAKES_ROOM_HIGH_RISK_VS_HIGH_STAKES = "High Risk vs. High Stakes"
    VENANTONIO_LABS_CRASHING_THE_PARTY = "Crashing the Party"
    VENANTONIO_LABS_OUT_OF_THE_FRYING_PAN = "Out of the Frying Pan..."
    VENANTONIO_CANALS_DANGER_OFF_STARBOARD = "Danger off Starboard"
    VENANTONIO_CANALS_POWER_JET_BOATING = "Power Jet Boating"
    MADAM_BUTTERQWARK_QWARKOGRAPHY_CH_3 = "Qwarkography, Ch. 3"
    GALACTIC_BOLT_RESERVE_HARD_CURRENCY = "Hard Currency"
    GALACTIC_BOLT_RESERVE_THE_BIG_HEIST = "The Big Heist"
    INSIDE_THE_A_EYE_PAYBACK_S_A_PUNCH = "Payback's a Punch"
    INSIDE_THE_A_EYE_MYE_MYNDE_IS_GOING = "Mye Mynde Is Going..."
    THE_SHOWERS_PLUMBING_TROUBLES = "Plumbing Troubles"
    THE_SHOWERS_RUB_A_DUB_DEATH = "Rub-a-dub-death"
    SPACESHIP_GRAVEYARD_TRACKING_THE_KINGPIN = "Tracking the Kingpin"
    SAINT_QWARK_QWARKOGRAPHY_CH_4 = "Qwarkography, Ch. 4"
    THE_QUASAR_FIELDS_ESCAPE_THE_KUDZU = "Escape the Kudzu"
    PRISON_BREAKOUT_THE_GREAT_ESCAPE = "The Great Escape"
    PRISON_BREAKOUT_AND_NOW_JUSTICE_FOR_ALL = "And Now... Justice For All"
    DAMS_EDGE_HYDRANO_SHIP_S_SIGNAL = "Ship's signal"
    DAMS_EDGE_HYDRANO_FOLLOW_THAT_CAR = "Follow that Car!"
    DAMS_EDGE_HYDRANO_THE_DRIFT_KING = "The Drift King"
    A_FICTION_FULL_OF_DOLLARS_QWARKOGRAPHY_CH_5 = "Qwarkography, Ch. 5"
    BULKHEAD_LOCK_UNDERWATER_BASE = "Underwater Base"
    BULKHEAD_LOCK_LOCKED_DOOR = "Locked Door"
    BULKHEAD_LOCK_INSULT_TO_INJURY = "Insult to Injury"
    UNDERWATER_BUNKER_CLANK_UNDER_GLASS = "Clank under glass"
    KLUNKS_LAIR_ALL_THE_MARBLES = "All The Marbles"

    BOLTAIRE_MUSEUM_COMPLETE = "Boltaire Museum Complete"
    BOLTAIRE_GEM_WING_COMPLETE = "Boltaire Gem Wing Complete"
    MAX_SECURITY_CELLS_COMPLETE = "Max-Security Cells Complete"
    ROOFTOP_DEATHTRAP_COMPLETE = "Rooftop Deathtrap Complete"
    LARGER_THAN_LIFE_COMPLETE = "Larger Than Life Complete"
    COUNTESS_VILLA_COMPLETE = "Countess's Villa Complete"
    ASYANICA_ROOFTOPS_COMPLETE = "Asyanica Rooftops Complete"
    GLACIARA_SKI_SLOPES_COMPLETE = "Glaciara, Ski Slopes Complete"
    THE_MESS_HALL_COMPLETE = "The Mess Hall Complete"
    AZCOTAL_ALLEY_COMPLETE = "Azcotal Alley Complete"
    GONDOLA_ASCENT_COMPLETE = "Gondola Ascent Complete"
    SUCK_AND_JIVE_COMPLETE = "Suck and Jive Complete"
    HIGH_ROLLERS_CASINO_COMPLETE = "High-Rollers Casino Complete"
    THE_EXERCISE_YARD_COMPLETE = "The Exercise Yard Complete"
    HIGH_STAKES_ROOM_COMPLETE = "High Stakes Room Complete"
    VENANTONIO_LABS_COMPLETE = "Venantonio Labs Complete"
    VENANTONIO_CANALS_COMPLETE = "Venantonio Canals Complete"
    MADAM_BUTTERQWARK_COMPLETE = "Madam Butterqwark Complete"
    GALACTIC_BOLT_RESERVE_COMPLETE = "Galactic Bolt Reserve Complete"
    INSIDE_THE_A_EYE_COMPLETE = "Inside the A-Eye Complete"
    THE_SHOWERS_COMPLETE = "The Showers Complete"
    SPACESHIP_GRAVEYARD_COMPLETE = "Spaceship Graveyard Complete"
    SAINT_QWARK_COMPLETE = "Saint Qwark Complete"
    THE_QUASAR_FIELDS_COMPLETE = "The Quasar Fields Complete"
    PRISON_BREAKOUT_COMPLETE = "Prison Breakout! Complete"
    DAMS_EDGE_HYDRANO_COMPLETE = "Dam's Edge, Hydrano Complete"
    A_FICTION_FULL_OF_DOLLARS_COMPLETE = "A Fiction Full Of Dollars Complete"
    BULKHEAD_LOCK_COMPLETE = "Bulkhead Lock Complete"
    UNDERWATER_BUNKER_COMPLETE = "Underwater Bunker Complete"
    KLUNKS_LAIR_COMPLETE = "Klunk's Lair Complete"

assert {v for k, v in vars(SACMissionLocations).items() if not k.startswith("_")} == (
    {entry.name for case in ALL_CASES for entry in CHAPTER_ENTRIES.get(case.name, ())}
    | {f"{case.name} Complete" for case in ALL_CASES}
