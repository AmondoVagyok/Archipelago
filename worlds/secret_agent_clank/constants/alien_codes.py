...
class SACAlienCodeLocations:
    ...
    ASYANICA_ROOFTOPS_GILBERTS_SECRET = "Clank: Asyanica Rooftops: Alien Code: Gilbert's secret"
    ASYANICA_ROOFTOPS_RICARDOS_SECRET = "Clank: Asyanica Rooftops: Alien Code: Ricardo's secret"
    GONDOLA_ASCENT_LEVITICUS_SECRET = "Clank: Gondola Ascent: Alien Code: Leviticus' secret"
    GONDOLA_ASCENT_CARLS_SECRET = "Clank: Gondola Ascent: Alien Code: Carl's secret"
    GONDOLA_ASCENT_JESS_SECRET = "Clank: Gondola Ascent: Alien Code: Jess' secret"
    AZCOTAL_ALLEY_JONS_SECRET = "Clank: Azcotal Alley: Alien Code: Jon's secret"
    AZCOTAL_ALLEY_THE_3_JASONS_SECRET = "Clank: Azcotal Alley: Alien Code: The 3 Jasons' secret"
    ...
    GALACTIC_BOLT_RESERVE_AVERYS_SECRET = "Clank: Galactic Bolt Reserve: Alien Code: Avery's secret"
    GALACTIC_BOLT_RESERVE_LESLEYS_SECRET = "Clank: Galactic Bolt Reserve: Alien Code: Lesley's secret"
    GALACTIC_BOLT_RESERVE_DAVES_SECRET = "Clank: Galactic Bolt Reserve: Alien Code: Dave's secret"
    SPACESHIP_GRAVEYARD_MATTS_SECRET = "Clank: Spaceship Graveyard: Alien Code: Matt's secret"
    SPACESHIP_GRAVEYARD_KENS_SECRET = "Clank: Spaceship Graveyard: Alien Code: Ken's secret"
    SPACESHIP_GRAVEYARD_JAREDS_SECRET = "Clank: Spaceship Graveyard: Alien Code: Jared's secret"
