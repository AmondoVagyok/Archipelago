"""All locations tied to Suck And Jive, grouped into 4 dicts by which
...
locations/__init__.py itself.
  ...
  - SUCK_AND_JIVE_LOCATIONS: always created (weapon vendor / gadget pickup /
    gadgetbot / special / ratchet challenge entries for this case).
  - SUCK_AND_JIVE_MISSION_LOCATIONS: level_completion granularity (default), gated by Missions.
  - SUCK_AND_JIVE_ALL_MISSIONS_LOCATIONS: all granularity, gated by Missions.
  - SUCK_AND_JIVE_CUTSCENE_LOCATIONS: gated by AllCutscenes.
  - SUCK_AND_JIVE_OTHER_LOCATIONS: this case's skill points + keycards + alien
