...
SPACESHIP_GRAVEYARD_LOCATIONS: dict[str, SACLocationData] = {}
for _name in WEAPONS_BY_CASE.get(_CASE_NAME, ()):
    SPACESHIP_GRAVEYARD_LOCATIONS[_name] = SACLocationData(_take_id(), _CASE_NAME)
for _name in (
...
SPACESHIP_GRAVEYARD_MISSION_LOCATIONS: dict[str, SACLocationData] = {
    f"{_CASE_NAME} Complete": SACLocationData(_take_id(), _CASE_NAME),
}

SPACESHIP_GRAVEYARD_ALL_MISSIONS_LOCATIONS: dict[str, SACLocationData] = all_mission_locations(_CASE_NAME, _take_id)

SPACESHIP_GRAVEYARD_CUTSCENE_LOCATIONS: dict[str, SACLocationData] = {
...
SPACESHIP_GRAVEYARD_OTHER_LOCATIONS: dict[str, SACLocationData] = {}
for _name in (
    *SKILL_POINTS_BY_CASE.get(_CASE_NAME, ()),
    *KEYCARDS_BY_CASE.get(_CASE_NAME, ()),
    *ALIEN_CODES_BY_CASE.get(_CASE_NAME, ()),
):
    SPACESHIP_GRAVEYARD_OTHER_LOCATIONS[_name] = SACLocationData(_take_id(), _CASE_NAME)
