"""All locations tied to Boltaire Museum, grouped into 4 dicts by which
...
locations/__init__.py itself.
  ...
  - BOLTAIRE_MUSEUM_LOCATIONS: always created (weapon vendor / gadget pickup /
    gadgetbot / special / ratchet challenge entries for this case).
  - BOLTAIRE_MUSEUM_MISSION_LOCATIONS: level_completion granularity (default), gated by Missions.
  - BOLTAIRE_MUSEUM_ALL_MISSIONS_LOCATIONS: all granularity, gated by Missions.
  - BOLTAIRE_MUSEUM_CUTSCENE_LOCATIONS: gated by AllCutscenes.
  - BOLTAIRE_MUSEUM_OTHER_LOCATIONS: this case's skill points + keycards + alien
