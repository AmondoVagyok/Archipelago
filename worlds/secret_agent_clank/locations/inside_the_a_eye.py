...
INSIDE_THE_A_EYE_MISSION_LOCATIONS: dict[str, SACLocationData] = {
    f"{_CASE_NAME} Complete": SACLocationData(_take_id(), _CASE_NAME),
}

INSIDE_THE_A_EYE_ALL_MISSIONS_LOCATIONS: dict[str, SACLocationData] = all_mission_locations(_CASE_NAME, _take_id)

INSIDE_THE_A_EYE_CUTSCENE_LOCATIONS: dict[str, SACLocationData] = {
...
INSIDE_THE_A_EYE_OTHER_LOCATIONS: dict[str, SACLocationData] = {}
for _name in (
    *SKILL_POINTS_BY_CASE.get(_CASE_NAME, ()),
    *KEYCARDS_BY_CASE.get(_CASE_NAME, ()),
    *ALIEN_CODES_BY_CASE.get(_CASE_NAME, ()),
):
    INSIDE_THE_A_EYE_OTHER_LOCATIONS[_name] = SACLocationData(_take_id(), _CASE_NAME)
